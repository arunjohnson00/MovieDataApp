...
const responsive = {
    ...
    useEffect(() => {
        ...
        axios.get('https://api.themoviedb.org/3/movie/top_rated?api_key=300b8d50d7d2846c15b04e2ef8e76195&language=en-US&page='+More).then((Response)=>{
    ...
    return (
        ...
        <div className="card">
            ...
            <div className="descriptions">
                ...
                <a href={"https://www.youtube.com/watch?v="+[...DataMovie][0]} onMouseOver={()=>setTitle(item.original_title)} target="_blank" rel="noreferrer">
                <button>
